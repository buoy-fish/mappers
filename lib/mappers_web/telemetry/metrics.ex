defmodule MappersWeb.Telemetry.Metrics do
  ...
  def handle_event_h3_res9_new([:ingest, :h3, :res9, :new], %{h3_res9_id: h3_res9_id}, _metadata, _config) do
  ...
  def handle_event_h3_res9_existing([:ingest, :h3, :res9, :existing], %{h3_res9_id: h3_res9_id}, _metadata, _config) do
    # do some stuff like log a message or report metrics to a service like StatsD
